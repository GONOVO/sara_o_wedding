  ...
  return (
    <div className="w-full relative">
      <video
        ...
        playsInline
      />
      <div className="bg-white w-full lg:w-[630px] lg:h-[240px] lg:p-2 lg:absolute lg:-bottom-[70px] lg:left-1/2 lg:translate-x-[-50%]">
