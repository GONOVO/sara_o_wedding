...
function Planners() {
  return (
    <section className="bg-[var(--lightGray-color)] py-20 lg:py-28 text-center text-[var(--mutedBlack-color)]">
      <div className="max-w-[380px] lg:max-w-[580px] mx-auto">
        <h2 className="text-2xl mb-8 nunito text-[var(--semiGray-color)] lg:text-[var(--mutedBlack-color)] tracking-widest lg:tracking-wider lg:px-0 px-4">
