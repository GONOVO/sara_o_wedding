    ...
    <>
      <div className="relative">
        <video
          ...
          muted
          playsInline
          poster="https://onnxbbbfkidlh7fg.public.blob.vercel-storage.com/sara-o-events/events_poster.webp"
          preload="metadata"
        />
      </div>

      <Ourvission
        image="https://onnxbbbfkidlh7fg.public.blob.vercel-storage.com/sara-o-events/events_vission.webp"
      ...
      />
      <ImageView
        imageSrc="https://onnxbbbfkidlh7fg.public.blob.vercel-storage.com/sara-o-events/f_ev4.webp"
        height="90vh"
        mb="0px"
        positionY="20%"
      />
      ...
      <Tellusmore video="/videos/ev_vid2.mp4" posterVideo="https://onnxbbbfkidlh7fg.public.blob.vercel-storage.com/sara-o-events/vf_7.webp" />
    </>
  );
}
