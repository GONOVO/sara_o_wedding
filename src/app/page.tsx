...
const InfinityScroll = dynamic(
  () => import("@/components/ui/infinityscroll/InfinityScroll")
);
    ...
    <>
      ...
      <section className="w-full md:h-[90vh] h-[50vh] relative">
        <LazyAutoPlayVideo
          ...
          placeholderImage="https://onnxbbbfkidlh7fg.public.blob.vercel-storage.com/sara-o-events/vid_h_place1.png"
        />
      </section>
      <Gallery />
