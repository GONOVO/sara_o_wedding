    ...
    <section className="w-full md:h-[90vh] h-[50vh] relative">
      <div className="absolute inset-0">
        <LazyAutoPlayVideo
          ...
          placeholderImage="/images/vf_8.webp"
          objectPosition="top"
        />
        <div className="w-full h-full bg-black opacity-25 absolute top-0"></div>
      </div>
      <div className="z-10 h-[100%] md:h-auto w-[92%] md:max-w-[860px] text-center flex flex-col gap-3 absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 justify-between">
        <h1
        ...
        <h2
          ...
          data-aos="fade-up"
        >
          TEXA <span className="text-black md:text-[96px] text-[11vw]">&</span>{" "}
          APPOEMN
        </h2>
      </div>
    </section>
