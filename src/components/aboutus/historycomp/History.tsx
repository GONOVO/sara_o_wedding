        ...
        <div className="grid grid-cols-2 lg:gap-0 gap-2 ">
          <div className="flex flex-col gap-y-8 items-center lg:-mt-20">
            <div className="w-[90%] lg:w-full h-[288px] md:h-[388px] relative">
              <Image
                src="https://onnxbbbfkidlh7fg.public.blob.vercel-storage.com/sara-o-events/schweppes_event.webp"
                alt="history Image 1"
                fill
            ...
            <div className="w-full lg:w-[90%] h-[268px] md:h-[368px] relative">
              <Image
                src="https://onnxbbbfkidlh7fg.public.blob.vercel-storage.com/sara-o-events/his2.webp"
                alt="history Image 1"
                fill
                className="object-cover"
                loading="lazy"
          ...
          <div className="flex flex-col gap-y-8  items-center lg:mt-20 mt-10">
            <div className="w-full lg:w-[86%] h-[209px] md:h-[309px] relative">
              <Image
                src="https://onnxbbbfkidlh7fg.public.blob.vercel-storage.com/sara-o-events/his3.webp"
                alt="history Image 1"
                fill
                className="object-cover"
                loading="lazy"
            ...
            <div className="w-[85%] lg:w-full h-[268px] md:h-[368px] relative">
              <Image
                src="https://onnxbbbfkidlh7fg.public.blob.vercel-storage.com/sara-o-events/his4.webp"
                alt="history Image 1"
                fill
                className="object-cover"
                loading="lazy"
