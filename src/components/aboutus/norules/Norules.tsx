      ...
      <div className="max-w-7xl grid lg:grid-cols-2 grid-cols-1 gap-10 lg:mx-auto mx-4 lg:px-4  relative">
        ...
        <div className="lg:text-start text-center">
          ...
          <p className="lg:max-w-[464px] leading-8 lg:text-base text-lg text-justify">
            ...
            firmly believe that nothing in a wedding must happen because a
            couple feels as though others expect it to happen. Gone are the days
            of bouquet tosses, receiving lines, and serving cake when you prefer
            pie. As with everything in life, if it feels right, that&apos;s how
            you know it&apos;s right. To put it simply, once in a life time
            experiences aren&apos;t created following age old methods. This
            mindset and fresh outlook on planning allows Estera Events to guide
