      ...
      <div className={`grid grid-cols-2 mt-[4rem] ${styles.res_grid}`}>
        <div className="grid lg:grid-cols-1 grid-cols-2 items-end">
          ...
          >
            ...
            <Image
              // src="https://onnxbbbfkidlh7fg.public.blob.vercel-storage.com/sara-o-events/featured2.webp"
              src="https://onnxbbbfkidlh7fg.public.blob.vercel-storage.com/sara-o-events/Dv_7.webp"
          ...
          >
            <Image
              // src="https://onnxbbbfkidlh7fg.public.blob.vercel-storage.com/sara-o-events/featured1.webp"
              src="https://onnxbbbfkidlh7fg.public.blob.vercel-storage.com/sara-o-events/Dv_4.webp"
