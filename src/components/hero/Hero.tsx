...
function Hero() {
  ...
  return (
    <section className="relative lg:mb-56 mb-0">
        ...
        <Link href="/events">
          <div className="relative group">
            ...
            <video
              ...
              muted
              playsInline
              poster="https://onnxbbbfkidlh7fg.public.blob.vercel-storage.com/sara-o-events/vf_1.webp"
              {...({
                fetchPriority: "high",
        ...
        <Link href="/wedding">
          <div className="relative group">
            ...
            <video
              ...
              muted
              playsInline
              poster="https://onnxbbbfkidlh7fg.public.blob.vercel-storage.com/sara-o-events/vf_2.webp"
              {...({
                fetchPriority: "high",
              } as React.VideoHTMLAttributes<HTMLVideoElement>)}
              onMouseEnter={() =>
