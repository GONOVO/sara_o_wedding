  ...
  return (
    <section className="overflow-x-hidden">
      <div className="max-w-[1280px] mx-auto mt-24 sm:mb-12 grid lg:grid-cols-[1.1fr_0.9fr] grid-cols-1 gap-1">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:max-w-full max-w-[430px]">
            ...
            >
              <div className="w-full h-full mt-3">
                <LazyAutoPlayVideo
                  videoPath={"/videos/last_vid.mp4"}
                  placeholderImage={"https://onnxbbbfkidlh7fg.public.blob.vercel-storage.com/sara-o-events/vf_3.webp"}
                />
              </div>
              {/* <video
                aria-hidden="true"
                ...
                muted
                playsInline
                poster="https://onnxbbbfkidlh7fg.public.blob.vercel-storage.com/sara-o-events/vf_3.webp"
              /> */}
            </div>
          </div>
        </div>
        ...
        >
          <Image
            src="https://onnxbbbfkidlh7fg.public.blob.vercel-storage.com/sara-o-events/galleryport7.webp"
            alt="real life"
            fill
