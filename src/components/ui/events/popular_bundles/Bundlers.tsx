  ...
  return (
    <section className="mt-36">
      <div className="w-full flex flex-col justify-center items-center">
        <div
          className="w-full h-[1px] bg-[var(--gold-color)]"
          data-aos="fade-up"
        ></div>
        <h1
          className="italic text-4xl text-[var(--gold-color)] max-w-[250px] text-center -mt-14"
          data-aos="fade-up"
        >
        ...
        <p
          className="text-xl max-w-[820px] text-center mx-auto px-2 my-10 text-[var(--gold-color)]"
          data-aos="fade-up"
          data-aos-delay={200}
        >
